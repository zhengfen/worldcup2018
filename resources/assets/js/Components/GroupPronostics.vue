    ...
    <article class="col mb-3">
        <div class="card card--group">
            ...
            <table class="table-bordered" v-if="withstanding">
                ...
                <tbody>
                <tr v-for="(standing, index) in group.getPronosticStandings()" :key="index" :class="standingpositon(index)">
            ...
            <div class="card-footer p-0">
                <table class="table-groups">
                    <tbody :class="[show ? 'tbody--open' : 'tbody--close']">
                        <pronostic v-for="(match, index) in group.getMatches()" :id="group.getName()" :game="match" :gametype="'groups'" :key="index" ></pronostic>
                    </tbody>
                </table>
...
<script>
    ...
    import Pronostic from './pronostic.vue';
    ...
    export default {
        ...
        methods: {
            ...
            pronostic(id){
                return this.pronostics.find(function (obj) { return obj.match_id === id; });
            }
        },
        computed: {
            show() {
